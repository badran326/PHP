...
class user {
    ...
    public function update($user_id, $username)
    {
        $sql = "UPDATE {$this->table} SET username = :username WHERE user_id = :user_id";
        $stmt = $this->conn->prepare($sql);
        return $stmt->execute(['username' => $username, 'user_id' => $user_id]);
    }
